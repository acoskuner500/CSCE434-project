...
public class TypeList extends Type implements Iterable<Type> {
    ...
    public boolean equals(Object o) {
        ...
        for (int i = 0; i < this.list.size(); i++) {
            ...
            // If they are arrays, need to check dimensions
            if (this.list.get(i) instanceof ArrayType) {
                ArrayType one = (ArrayType) this.list.get(i);
                ArrayType two = (ArrayType) tList.list.get(i);
