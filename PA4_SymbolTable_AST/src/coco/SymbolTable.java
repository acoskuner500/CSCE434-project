...
public class SymbolTable {
    ...
    public SymbolTable () {
        ...
        overloads.add(new Symbol("readInt", new FuncType(null, new IntType())));
        globalScope.put("readInt", overloads);

        overloads = new ArrayList<Symbol>();
        overloads.add(new Symbol("readBool", new FuncType(null, new BoolType())));
        ...
        overloads = new ArrayList<Symbol>();
        overloads.add(new Symbol("println", new FuncType(null, new VoidType())));
